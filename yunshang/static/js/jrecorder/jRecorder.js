...
(function($) {
    ...
    $.jRecorder.stop = function() {
        ...
        //function call to stop recording                   
    $.jRecorder.playAudio = function() {

        getFlashMovie(jRecorderSettings['recorder_name']).jPlayAudio();

    }
    $.jRecorder.stopAudio = function() {

            getFlashMovie(jRecorderSettings['recorder_name']).jStopAudio();
    ...
    $.jRecorder.callback_finished_sending = function(res) {
        jRecorderSettings['callback_finished_sending'](res);
